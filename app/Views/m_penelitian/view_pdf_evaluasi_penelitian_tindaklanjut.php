    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    <iframe src="<?= base_url("public/upload/file_evaluasi_penelitian_tindaklanjut/" . $file['evaluasi_penelitian_tindaklanjut']);  ?>" height="500" width="100%" title="Iframe Example" id="ubah"></iframe>
